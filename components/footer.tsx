      ...
      <div className="flex flex-col">
        <div className="rounded-2xl bg-primary p-8">
          <form>
            <div className="flex flex-col items-center gap-5 md:flex-row">
              ...
              <div className="flex w-full flex-1 flex-col items-center gap-3 rounded-xl bg-background p-3 md:basis-2/3 md:flex-row">
                <input
                  type="text"
        ...
        <div className="border-b border-neutral-20">
          <div className="my-10 flex flex-col flex-wrap justify-between gap-4 md:flex-row">
            <ul className="flex flex-col items-center justify-center gap-3 md:gap-[60px] md:flex-row">
